...
@endif
        ...
        {{-- Logo --}}
        <a href="{{ route('home') }}" class="font-bold tracking-wide text-[var(--color-logo-tta)] pr-2 select-none">TTA</a>
        ...
        <div class="relative group">
          ...
          <div class="absolute left-0 mt-2 hidden group-hover:block z-50">
            <div class="min-w-[240px] dropdown-panel">
              <a href="{{ route('blog.index') }}" class="dropdown-item">Semua Artikel</a>
              <a href="{{ route('blog.portfolio') }}" class="dropdown-item">Portofolio</a>
          ...
          <div class="relative group">
            ...
            <div class="absolute left-0 mt-2 hidden group-hover:block z-50">
              <div class="min-w-[220px] dropdown-panel">
                ...
                @endif
                <a href="{{ route('leads.index') }}" class="dropdown-item">Leads</a> {{-- Link admin di sini --}}
